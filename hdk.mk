...
ifndef CL_DIR
$(error $(shell echo -e "$(RED)MAKE ERROR: CL_DIR undefined while trying to configure HDK Environment. Did you include environment.mk?$(NC)")
endif
...
$(info MAKE INFO: HDK_SHELL_DESIGN_DIR is defined as: $(HDK_SHELL_DESIGN_DIR))
$(info MAKE INFO: Assuming remaining HDK variables are set)
...
$(warning $(shell echo -e "$(ORANGE)MAKE WARN: Using $(CL_DIR)/../aws-fpga as AWS_FPGA_REPO_DIR variable$(NC)"))
...
$(error $(shell echo -e "$(RED)MAKE ERROR: HDK variables undefined and aws-fpga directory not found. Run \`source hdk_setup.sh\` in aws-fpga.$(NC)"))
endif
